...
function reviseNoticeCheck() {
    ...
    if (flag) {
        location.href="/adminNotice/notice";
        alert('수정 완료');
    }
}
...
function reviseBannerCheck() {
    ...
    if (flag) {
        location.href="/adminBanner/banner";
        alert('수정 완료');
    }
}
...
function reviseCropInformationCheck() {
    ...
    if (flag) {
        location.href="/adminCropInformation/cropInformation";
        alert('수정 완료');
    }
}
...
function revisePolicyCheck() {
    ...
    if (flag) {
        location.href="/adminPolicy/policy";
        alert('수정 완료');
    }
}
